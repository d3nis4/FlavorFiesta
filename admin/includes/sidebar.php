      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page=="products.php"?'active bg-gradient-primary':'';  ?> " href="products.php">
            ...
            <span class="nav-link-text ms-1">Toate retetele</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page=="add-product.php"?'active bg-gradient-primary':'';  ?> " href="add-product.php">
            ...
            <span class="nav-link-text ms-1">Adaugă reteta</span>
          </a>
        </li>
       
        <li class="nav-item">
          <a class="nav-link text-white <?= $page=="recenzii.php"?'active bg-gradient-primary':'';  ?>  " href="recenzii.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
            <span class="nav-link-text ms-1">Recenzii</span>
          </a>
        </li>
